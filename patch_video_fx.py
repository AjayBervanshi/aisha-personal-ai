...
# We need to add the cinematic post-processing step to produce_video()
old_code = """    concat_cmd = [
...
new_code = """    raw_output = os.path.join("temp_video", f"raw_{output_filename}")
    ...
    try:
        ...
        # Post-Processing: Cinematic FX (Film Grain + Vignette + Letterbox 9:16)
        # Vignette + Grain creates the moody cinematic feel
